...
Security issues in scripts, workflows, or docs that could lead to unsafe usage
are in scope.
...
- GitHub Security Advisories (preferred): Security tab -> Report a
  vulnerability
- Contact repository maintainers directly if advisory flow is unavailable
...
- Coordinated disclosure is expected; avoid public disclosure before fix
  availability
